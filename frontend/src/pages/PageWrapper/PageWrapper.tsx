...
export default function PageWrapper({ children }: { children: ReactNode }) {
    ...
    return (
        <div className={isNewEnroll ? `${classes.WrapperOverlay}` : `${classes.Wrapper}`} onClick={(e) => wrapperClick(e)} ref={wrapperRef}>
            ...
            {isNewEnroll &&
                <form id="new_enroll" className={classes.NewEnroll}>
                    ...
                    <div className={classes.StudInfo}>
                        <div className={classes.InfoBlocks}>
                            ...
                            <input type="text" id="email" name="email" className={classes.InfoInput} required placeholder="m2300000@edu.misis.ru" />
                        </div>
                        <div className={`${classes.InfoBlocks}`}>
                            <label>Пол</label>
                        ...
                        <div className={classes.InfoBlocks}>
                            ...
                            <select name="country" id="country" className={classes.InfoInput}>
                                <option value="Russian Federation" selected>Россия</option>
                    ...
                    <button className="DefaultButton_1">Добавить новую запись</button>
                </form>
            }
        </div>
    )
