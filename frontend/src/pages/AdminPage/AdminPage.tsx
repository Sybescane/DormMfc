    ...
    return (
        <div className={classes.Wrapper}>
            ...
            <div className={classes.Controls}>
                ...
                <button type='button' className={classes.AddStudent}>
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 7H7M7 7H13M7 7V1M7 7V13" stroke="#1D92F8" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <p>Добавить запись</p>
                </button>
            </div>
